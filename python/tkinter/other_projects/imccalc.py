...
class WeightInput(ctk.CTkFrame):
    def __init__(self,parent,weight_float,metric_bool):
        ...
        #Widgets
        font = ctk.CTkFont(family=FONT,size=INPUT_FRONT_SIZE)
        ...
        small_plus_button.grid(row=0,column=3,padx =8,pady=4)
        ...
        small_minus_button.grid(row=0,column=1,padx =8,pady=4)
...
class HeightInput(ctk.CTkFrame):
    def __init__(self, parent,height_int,metric_bool):
        ...
        self.metric_bool = metric_bool
        # widgets
        slider = ctk.CTkSlider(master=self,command=self.update_text,button_color=GrERN,button_hover_color=GRAY,progress_color=GrERN,fg_color=LIGHT_GRAY,variable=height_int,from_=100,to=250)
        slider.pack(side='left',fill='x',expand=True,pady=10,padx=10)

        self.output_string = ctk.StringVar()
        self.update_text(height_int.get())

        output_text = ctk.CTkLabel(self,textvariable=self.output_string,text='1.80m',text_color=BLACK,font=ctk.CTkFont(family=FONT,size=INPUT_FRONT_SIZE))
...
class UnitSwitcher(ctk.CTkLabel):
    def __init__(self,parent,metric_bool):
        super().__init__(master=parent,text='metric',text_color=DARK_GREEN,font=ctk.CTkFont(family=FONT,size=INPUT_FRONT_SIZE,weight='bold'))
