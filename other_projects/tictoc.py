...
def next_turn(row,column):
    global player
    if buttons[row][column]['text'] == "" and check_winner() is False: ## acess text of button
        if player == players[0]:
...
## Cria matrix e a apresenta (Carlos Henrique)
window = Tk()
...
#matriz com os botões
buttons = [[0,0,0],
           [0,0,0],
           [0,0,0]]

#Que jogador esta jogando
